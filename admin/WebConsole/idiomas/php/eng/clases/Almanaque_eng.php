...
class Almanaque{
	...
	function __construct($pclase="", $ponmouseover="sobre(this)", $ponmouseout="fuera(this)", $ponclick="clic(this)"){ //Constructor
		...
		$this->semanas[1]=array ("1ª",0x01); // size 1 bytes
		...
		$this->numero_annos[2010]=0x0001; // size 2 bytes
		...
		$this->numero_dias[1]=0x00000001; // size 4 bytes
		...
		$this->numero_horas[1]=array	("0:00",	 0x0001);  // size 2 bytes
...
/*
		$this->numero_horas[1]=array ("8:00",0x00000001);  // size 4 bytes
