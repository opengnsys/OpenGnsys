...
export class AccordionComponent implements OnInit {
  ...
  @ContentChild(AccordionHeaderComponent, { static: false}) public accordionHeaderComponent: AccordionHeaderComponent;
  @ContentChild(AccordionContentComponent, { static: false}) public accordionContentComponent: AccordionContentComponent;
