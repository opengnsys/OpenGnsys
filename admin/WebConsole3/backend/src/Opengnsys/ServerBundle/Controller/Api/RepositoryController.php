...
{	
	...
	public function cgetAction(Request $request, ParamFetcherInterface $paramFetcher)
	{
		...
		$objects = $this->container->get('opengnsys_server.repository_manager')->searchBy($limit, $offset, $matching);
	...
	public function cpostAction(Request $request)
	{
        $request->setRequestFormat($request->get('_format'));
		try {
			$object = $this->container->get('opengnsys_server.repository_manager')->post(
					$request->request->all()
			);	
	...
	public function patchAction(Request $request, $slug)
	{
        $request->setRequestFormat($request->get('_format'));
		try {
			$object = $this->container->get('opengnsys_server.repository_manager')->patch(
					$this->getOr404($slug),
					$request->request->all()
			);
	...
	public function deleteAction(Request $request, $slug)
	{
        $request->setRequestFormat($request->get('_format'));
		$object = $this->getOr404($slug);
		$object = $this->container->get('opengnsys_server.repository_manager')->delete($object);
	...
	{
		if (!($object = $this->container->get('opengnsys_server.repository_manager')->get($slug))) {
