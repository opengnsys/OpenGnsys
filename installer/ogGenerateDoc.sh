#!/bin/bash
#/**  @function ogGenerateDoc: @brief Genera Documentación Doxygen .
#@param $1 str_pathOrigen del codigo
#@param $2 str_pathDestino de la documentacion.
#@param ejemplo ogGenerateDoc /home/adv/workspace/opengnsys/trunk/clients/engine /opt/opengnsys/www/doc
#@return genera la documentacion en el path indicado como parametro2.
#@warning  Salidas de errores propia de doxygen
#@attention
#@version 1.0       Date: 01/06/2009                 Author Antonio J. Doblas Viso. Universidad de Malaga
#@note	  requiere doxygen y graphviz
#*/
#
if [ $# = 0 ]
then
